...
Hart<URV>::disassembleInst(const DecodedInst& di, std::ostream& out)
{
  ...
  switch(id)
    ...
    case InstId::vfwmul_vv:
      printVec_vv(*this, out, "vfwmul.vv", di);
      break;

    case InstId::vfwmul_vf:
      printVec_vf(*this, out, "vfwmul.vf", di);
      break;
    ...
    case InstId::vfwmacc_vv:
      printVec_vv(*this, out, "vfwmacc.vv", di);
      break;

    case InstId::vfwmacc_vf:
      printVec_fv(*this, out, "vfwmacc.vf", di);
      break;

    case InstId::vfwnmacc_vv:
      printVec_vv(*this, out, "vfwnmacc.vv", di);
      break;

    case InstId::vfwnmacc_vf:
      printVec_fv(*this, out, "vfwnmacc.vf", di);
      break;

    case InstId::vfwmsac_vv:
      printVec_vv(*this, out, "vfwmsac.vv", di);
      break;

    case InstId::vfwmsac_vf:
      printVec_fv(*this, out, "vfwmsac.vf", di);
      break;

    case InstId::vfwnmsac_vv:
      printVec_vv(*this, out, "vfwnmsac.vv", di);
      break;
    ...
    case InstId::vfmv_v_f:
     ...
     case InstId::vfcvt_xu_f_v:
       printVec_v(*this, out, "vfcvt.xu.f.v", di);
       break;

     case InstId::vfcvt_x_f_v:
       printVec_v(*this, out, "vfcvt.x.f.v", di);
       break;

     case InstId::vfcvt_rtz_xu_f_v:
       printVec_v(*this, out, "vfcvt.rtz.xu.f.v", di);
       break;

     case InstId::vfcvt_rtz_x_f_v:
       printVec_v(*this, out, "vfcvt.rtz.x.f.v", di);
       break;

     case InstId::vfcvt_f_xu_v:
       printVec_v(*this, out, "vfcvt.f.xu.v", di);
       break;

     case InstId::vfcvt_f_x_v:
       printVec_v(*this, out, "vfcvt.f.x.v", di);
       break;

     case InstId::vfwcvt_xu_f_v:
       printVec_v(*this, out, "vfwcvt.xu.f.v", di);
       break;

     case InstId::vfwcvt_x_f_v:
       printVec_v(*this, out, "vfwcvt.x.f.v", di);
       break;

     case InstId::vfwcvt_rtz_xu_f_v:
       printVec_v(*this, out, "vfwcvt.rtz.xu.f.v", di);
       break;

     case InstId::vfwcvt_rtz_x_f_v:
       printVec_v(*this, out, "vfwcvt.rtz.x.f.v", di);
       break;

     case InstId::vfwcvt_f_xu_v:
       printVec_v(*this, out, "vfwcvt.f.xu.v", di);
       break;
     ...
     case InstId::vfncvt_xu_f_w:
       printVec_v(*this, out, "vfncvt.xu.f.w", di);
       break;

     case InstId::vfncvt_x_f_w:
       printVec_v(*this, out, "vfncvt.x.f.w", di);
       break;

     case InstId::vfncvt_rtz_xu_f_w:
       printVec_v(*this, out, "vfncvt.rtz.xu.f.w", di);
       break;

     case InstId::vfncvt_rtz_x_f_w:
       printVec_v(*this, out, "vfncvt.rtz.x.f.w", di);
       break;

     case InstId::vfncvt_f_xu_w:
       printVec_v(*this, out, "vfncvt.f.xu.w", di);
       break;

     case InstId::vfncvt_f_x_w:
       printVec_v(*this, out, "vfncvt.f.x.w", di);
       break;

     case InstId::vfncvt_f_f_w:
       printVec_v(*this, out, "vfncvt.f.f.w", di);
       break;
