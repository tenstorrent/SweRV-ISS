...
{
  static constexpr auto table = std::to_array<uint32_t>(
    {
      0x00000001,
      0x00000002,
      0x00000004,
...
sm4_sbox(uint8_t x)
{
  static constexpr auto sm4_sbox_table = std::to_array<uint8_t>(
    {
...
{
  static constexpr auto aes_sbox_fwd_table = std::to_array<uint8_t>(
    {
...
{
  static constexpr auto aes_sbox_inv_table = std::to_array<uint8_t>(
    {
